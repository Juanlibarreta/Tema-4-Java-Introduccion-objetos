...
public class Rectangulo implements Cloneable, Comparable<Rectangulo>{
    ...
    public Rectangulo setAncho(int v){
        if(v < 2){
            throw new IllegalArgumentException("Ancho debe ser mayor que 1");
        }
    ...
    public Rectangulo setAlto(int v){
        if(v < 2){
            throw new IllegalArgumentException("Alto debe ser mayor que 1");
        }
    ...
    public Rectangulo setBorde(char v){
        if(v != '*' && v != '+' && v != '-'){
            throw new IllegalArgumentException("Borde debe ser '*', '+' o '-'");
        }
        this.borde = v;
        return this;
    }
    public Rectangulo setRelleno(char v){
        if(v != '*' && v != '+' && v != '-' && v != ' '){
            throw new IllegalArgumentException("Relleno debe ser '*', '+', '-' o ' '");
        }
        this.relleno = v;
        return this;
    }
